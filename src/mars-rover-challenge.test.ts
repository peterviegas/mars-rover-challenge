...
describe("test validatePositionCurrentMars function and movMars", () => {
  ...
  it("sending the coordinates 1 2 N should return 1 3 N", () => {
  ...
  it("sending the coordinates 3 3 E should return 5 1 E", () => {
  ...
  it("sending the coordinates 59, 41, W should return 58 51 N", () => {
